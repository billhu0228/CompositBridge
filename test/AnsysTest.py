...
span4 = Span(120)
span5 = Span(160)
sps = [span1, span2, span3, span4, span5]
# sps = [span1, span2]
...
s2 = ISection(2, "I1800", offset=(0, 0.9), w1=0.7, w2=0.6, w3=1.8, t1=0.032, t2=0.024, t3=0.018)
s3 = ISection(3, "I300", offset=(0, 0.15), w1=0.3, w2=0.6, w3=0.3, t1=0.010, t2=0.010, t3=0.008)
